      ...
      <div className="max-w-4xl w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="md:col-span-2 flex flex-col gap-6 h-full">
            <Reveal delay={0.1} className="flex-1 h-full">
              <GlassCard className="h-full">
                <div className="flex items-center gap-4 h-full">
                  <div className="w-12 h-12 rounded-full bg-white dark:bg-slate-800 flex items-center justify-center border border-gray-200 dark:border-slate-700 shadow-sm transition-colors duration-500 shrink-0">
                  ...
                  <div>
                    ...
                    <a href="mailto:mohit96038@gmail.com" className="text-gray-900 dark:text-white hover:text-gray-600 dark:hover:text-gray-300 font-medium transition-colors">mohit96038@gmail.com</a>
                  </div>
                </div>
              </GlassCard>
            </Reveal>
            
            <Reveal delay={0.2} className="flex-1 h-full">
              <GlassCard className="h-full">
                <div className="flex items-center gap-4 h-full">
                  <div className="w-12 h-12 rounded-full bg-white dark:bg-slate-800 flex items-center justify-center border border-gray-200 dark:border-slate-700 shadow-sm transition-colors duration-500 shrink-0">
                  ...
                  <div>
                    ...
                    <span className="text-gray-900 dark:text-white font-medium transition-colors duration-500">A132/Block 2, Greater Noida, Uttar Pradesh, 201306, India</span>
                  </div>
                </div>
              </GlassCard>
            </Reveal>
              ...
              <GlassCard className="h-full">
                <form className="flex flex-col gap-4 h-full" onSubmit={handleSubmit}>
                  ...
                  <div className="flex flex-col gap-1 flex-1">
                    ...
                    <textarea required id="message" className="flex-1 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl px-4 py-3 text-gray-900 dark:text-white focus:outline-none focus:border-gray-400 dark:focus:border-slate-500 transition-colors resize-none shadow-sm" placeholder="Your message here..."></textarea>
                  </div>
                  <button 
                    type="submit" 
